...
> **Status:** Die folgenden Punkte werden im Rahmen der neuen Architektur-Epics adressiert. Siehe [Design Documents Index](./SWD/_index.md).

### 1. Synchrones RxJS Anti-Pattern in `PageViewComponent`
*Status: ✅ Abgeschlossen (Lösung in: [Eager Caching System](./SWD/eager-caching-design.md))*
...
*Status: ✅ Abgeschlossen (Siehe [Tasks](./tasks.md))*
