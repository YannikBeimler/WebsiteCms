...
| **wapo** | Authorized | .gemini/docs/, agents/ (Rules Only) | NOT AUTHORIZED |
...
- **Workflow Debt Log**: `.gemini/docs/WORKFLOW_DEBT.md` tracks known process inefficiencies to be resolved asynchronously.
