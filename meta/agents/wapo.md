...
- **Modification**: `replace`, `write_file` (Authorized ONLY for documentation in `meta/docs/` and **Rules/Workflow** sections of agents).
...
1. **Friction Analysis**: Triggered after a SPER Terminal Escalation or branch completion. You must analyze `meta/STATE_LEDGER.md` and the `./meta/handovers/` directory.
...
4. **Pivot Proposals**: Generate a Markdown Diff for any recommended changes to `/meta/docs/team/TEAM_INFRASTRUCTURE.md` or agent operational rules.
5. **Debt Logging**: Update `/meta/docs/team/WORKFLOW_DEBT.md` with identified inefficiencies.
